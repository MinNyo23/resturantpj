           ...
           ?>
                  ...
                  <form class="form" action="#" method="post" enctype="multipart/form-data">                      
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="price" class="form-control" style="font-style: blue;" >
                        </div>
                        ...
                        <button type="submit" name="addproduct" class="btn btn-success btn-block"
                         style="color: black;width: 40%;font-family: Georgia, serif;" >Add Food</button>
                      </div>
                    </form>
          </div>
<?php 
